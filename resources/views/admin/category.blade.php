                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            ...
                            <p class="card-category"> Kategoriler Tablosu</p>
                            <a href="{{route('admin_category_add')}}" style="position: absolute; right: 30px;font-style: bold; background-color:#4a5568; border-color: #95999c">Kategori Ekle</a><br>
                        </div>
                        <div class="card-body">
