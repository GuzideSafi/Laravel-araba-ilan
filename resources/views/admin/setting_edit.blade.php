                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            ...
                            <p class="card-category"> Ayarları Düzenleme Sayfası</p>
                        </div>
                        <div class="card-body">
                            <div style="width:200px; height: 1500px;">
                                <form action="{{route('admin_setting_update')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <table>
                                        ...
                                        <tr><button type="submit" style="color:#95999c; background-color: #4a5568; width: 150px;">Ayarları Düzenle</button></tr>
                                    </table>
                                </form>
                            </div>
                        </div>
